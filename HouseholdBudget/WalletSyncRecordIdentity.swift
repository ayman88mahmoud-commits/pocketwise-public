...
enum WalletSyncRecordEntity: String, CaseIterable, Codable, Hashable {
    ...
    case installmentPlanDeletion = "InstallmentPlanDeletion"
    case creditCardPurchaseDeletion = "CreditCardPurchaseDeletion"
    case creditCardPaymentDeletion = "CreditCardPaymentDeletion"
    case personDebtDeletion = "PersonDebtDeletion"
    case personDebtEntryDeletion = "PersonDebtEntryDeletion"
    case monthlyBudgetItemDeletion = "MonthlyBudgetItemDeletion"
